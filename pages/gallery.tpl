	...
	<div id="hero" class="w3-row">
		<div class="w3-col hero-wrap">
			<img src="[@URL]images/hero_images/view_from_choughs_nest_hotel.jpg" style="width:100%; height: 100%;" alt="View of Foreland Point and Bristol Channel from Chough's Nest Hotel, Devon">
