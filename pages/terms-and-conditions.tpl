	...
	<div class="w3-container">
		...
		<a id="back_to_top" href="#page-title" class="w3-display-right menu-button iris-bg floral-white-text">&uarr;</a>
		<div class="content">
			<div class="w3-row grid-wrap">
				...
				<h3>Damage</h3>
				<p>We reserve the right and you authorise us to charge your valid credit or debit card for any damage caused to the hotel room
				that you are staying in, or to any area of the hotel during your stay, or for missing items.</p>
				
				<h3>Fire Safety &amp; Behaviour</h3>
				<p>All guests are advised on check-in to take notice of the hotel fire precautions and to familiarise themselves with the fire exit route.</p>
				...
				and the site wont work as expected without them. These cookies are set when you submit 
