							...
							<div class="w3-col grid-col s12 m6 l8 xl9">
								...
								<div class="rest_contact">
									<p>
										...
										<a href="https://www.theoldbanklynton.co.uk/" target="_blank">www.theoldbanklynton.co.uk</a><br>
										<strong>Location:</strong> Church Steps, Lynton, EX35 6HY
									</p>
								</div>
							</div>
							...
							<div class="w3-col grid-col s12 m6 l8 xl9">
								...
								<div class="rest_contact">
									<p>
										...
										<a href="https://www.thecrownlynton.co.uk/" target="_blank">www.thecrownlynton.co.uk</a><br>
										<strong>Location:</strong> Market Street, Lynton, EX35 6AG
									</p>
								</div>
						...
						<div class="w3-row grid-wrap">
							<div class="w3-col grid-col s12 m6 l8 xl9">
								...
								<div class="rest_contact">
									...
									<a href="https://www.thevanillapodlynton.co.uk/" target="_blank">www.thevanillapodlynton.co.uk</a><br>
									<strong>Location:</strong> 10-12, Queen Street, Lynton, EX35 6AA
								</p>
								</div>
							...
							<div class="w3-col grid-col s12 m6 l8 xl9">
								...
								<div class="rest_contact">
									<p>
										...
										<a href="https://www.cottageinnlynton.co.uk/" target="_blank">www.cottageinnlynton.co.uk</a><br>
										<strong>Location:</strong> Lynbridge, Lynton, EX35 6NR
									</p>
								</div>
							...
							<div class="w3-col grid-col s12 m6 l8 xl9">
								...
								<div class="rest_contact">
									<p>
										...
										<a href="https://www.rockhouselynmouth.co.uk/dine" target="_blank">www.rockhouselynmouth.co.uk/dine</a><br>
										<strong>Location:</strong> Manor Green, Lynmouth, EX35 6EN
									</p>
								</div>
							...
							<div class="w3-col grid-col s12 m6 l8 xl9">
								...
								<div class="rest_contact">
									<p>
										...
										<a href="https://www.bathhotellynmouth.co.uk/dining" target="_blank">www.bathhotellynmouth.co.uk/dining</a><br>
										<strong>Location:</strong> The Harbour, Lynmouth, EX35 6EL
									</p>
								</div>
					...
					<div class="w3-padding-large w3-margin-bottom champagne-bg">
						<div class="w3-row grid-wrap">
							<div class="w3-col grid-col s12 m6 l8 xl9">
								...
								<div class="rest_contact">
									<p>
										<strong>Distance:</strong> 7 minutes drive<br>
										<strong>Telephone:</strong> 01598 741 263<br>
										<a href="https://blueballinn.com/" target="_blank">www.blueballinn.com</a><br>
										<strong>Location:</strong> Countisbury, EX35 6NE
									</p>
								</div>
					...
					<div class="w3-padding-large w3-margin-bottom champagne-bg">
						<div class="w3-row grid-wrap">
							<div class="w3-col grid-col s12 m6 l8 xl9">
								...
								<div class="rest_contact">
									<p>
										<strong>Distance:</strong> 14 minutes drive<br>
										<strong>Telephone:</strong> 01598 763 239<br>
										<a href="https://www.foxandgooseinnexmoor.co.uk/page/Food" target="_blank">www.foxandgooseinnexmoor.co.uk</a><br>
										<strong>Location:</strong> Parracombe, EX31 4PE
									</p>
								</div>
